...
public class Elastic implements Scenario<SearchSourceBuilder, SearchResponse> {

    private static final Lazy<Client> client = Lazy.of(() ->
            Try.of(() -> connect()).get());
    ...
    @Benchmark
    public SearchResponse useCase1() throws Exception {
        return runUseCase1();
    }
    ...
    @Benchmark
    public SearchResponse useCase2() throws Exception {
        return runUseCase1();
    }
    ...
    @Benchmark
    public SearchResponse useCase3() throws Exception {
        return runUseCase3();
    }
    ...
    @Benchmark
    public SearchResponse useCase4() throws Exception {
        return runUseCase4();
    }
    ...
    @Benchmark
    public SearchResponse useCase5() throws Exception {
        return runUseCase5();
    }
    ...
    @Benchmark
    public SearchResponse useCase6() throws Exception {
        return runUseCase6();
    }
    ...
    @Benchmark
    public SearchResponse useCase7() throws Exception {
        return runUseCase7();
    }
